...
This project will attempt to keep all of your Drupal Core files up-to-date; if you customize any of the "scaffolding" files (commonly .htaccess), you may need to merge conflicts if any of your modfied files are updated in a new release of Drupal core.
